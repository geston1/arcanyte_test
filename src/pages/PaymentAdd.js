...
const PaymentAdd = () => {
    ...
    const onChangeEvent = (event) => {
        if (event.target.name == "amount")
            event.currentTarget.value = Math.max(event.currentTarget.value, 0.01);
        setFields({
            ...fields,
